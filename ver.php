  ...
  <div class="container-fluid">
	...
	<?php
		...
		echo "<thead> <tr> <td>ID</td>
			...
			<tr>
				<td><?php echo $columna['idProducto']?></td>
				<td><?php echo $columna['Tipo']?></td>
				<td><?php echo $columna['Sabor']?></td>
				<td><?php echo $columna['Descripcion']?></td>
				<td><?php echo $columna['Precio']?></td>
				<td><img width="30%" src="data:images/png;base64, <?php echo base64_encode($columna['Imagen']); ?>"/></td>
				<th><a class="btn btn-info btn-sm" href="modificacion.php?idx=<?php echo $columna ['idProducto']; ?>"><span class="glyphicon glyphicon-edit"> Editar </span></a></th>
				<th><a class="btn btn-danger btn-sm" href="eliminarproductos.php?idx=<?php echo $columna ['idProducto']; ?>"><span class="glyphicon glyphicon-trash"> Eliminar </span></a></th>
			</tr>
					<?php
					//echo "<tr>";
					//echo"<thead>";
